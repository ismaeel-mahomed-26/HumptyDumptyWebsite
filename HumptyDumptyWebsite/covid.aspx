<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="covid.aspx.cs" Inherits="M4.covid" %>
...
{%><!-- #include file="outnav.aspx" --><%}%>
    ...
    <div class="row">
        ...
        <div class="col-sm-10 col-12">
            <iframe src="./COVID/selectChild.aspx" frameborder="0" style="border:0;" allowfullscreen="" id="covidEmbed" aria-hidden="false" tabindex="0"></iframe>
        </div>
        <div class="col-sm-1 col-12"></div>
    </div>
