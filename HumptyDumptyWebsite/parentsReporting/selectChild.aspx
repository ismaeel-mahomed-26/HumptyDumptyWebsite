<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectChild.aspx.cs" Inherits="M4.parentsReporting.selectChild" %>
    ...
    <form id="form1" runat="server">
        <div style="width:30%; min-width:400px; margin:auto; margin-top:100px;">
            <%
                ...
                <table>
                    <tr>
                        <td><b>Select a child to view their reports:</b></td>
                    </tr>
                    <%
                    ...
                    <tr>
                        <td>
                            <input type="submit" runat="server" id="proceedBtn" value="Proceed" />
                        </td>
                    </tr>
                </table>
        </div>
